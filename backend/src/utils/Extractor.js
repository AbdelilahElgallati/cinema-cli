...
const bigwarp = /(?:\/\/|\.)((?:bigwarp|bgwp)\.(?:io|cc|art))\/(?:e\/|embed-)?([0-9a-zA-Z=]+)/;
const filelions =
...
const savefiles = /(?:\/\/|\.)(?:savefiles|streamhls)\.(?:com|to)\/(?:e\/)?([0-9a-zA-Z]+)/;
const doodstream =
...
const dropload = /(?:\/\/|\.)(dropload\.io|dropload\.tv)\/(?:embed-|e\/|d\/)?([0-9a-zA-Z]+)/;
const vidmoly = /(?:\/\/|\.)(vidmoly\.(?:me|to|net))\/(?:embed-|w\/)?([0-9a-zA-Z]+)/;
